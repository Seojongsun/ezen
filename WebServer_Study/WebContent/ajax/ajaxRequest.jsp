...
<script type="text/javascript">
	$(function() {
		...
		$('#register').click(function() {
			//input id . 요소의 속성값을 탐색하여 속성값을 반환한다
			var id = $("input[name='id']").val();
			//input password . 요소의 속성값을 탐색하여 속성값을 반환한다
			...
			$.ajax({
				...
				url : "./ajaxData.jsp",
				type : "GET",
				// GET . 메소드 전송 방식으로 데이터를 쿼리 문자열로 설정한다
			...
			// 값이 없거나 ""( ), 0, NaN, null, undefined false false . 빈 문자열 의 객체 초기값은 가 되므로 로 반환한다
			return false;
		});
	});
</script>
