    ...
    <div class="col-md-12">
     <div class="card">
      <div class="card-header">
       <h3 class="text-muted"><i class="fas fa-edit mr-sm-1"></i>답변글 등록</h3>
      </div>
      <div class="card-body">
       <form action="./BoardReply.do" method="post" id="checkForm" enctype="multipart/form-data">
        <fieldset>
        ...
        <div class="col col-md-10">        
         <input type="hidden" name="id" value="${sessionScope.id}">
          ...
          <input type="hidden" name="answernum" value="${boardDTO.answernum}">
     <input type="hidden" name="answerlev" value="${boardDTO.answerlev}">
     <input type="hidden" name="answerseq" value="${boardDTO.answerseq}">
         ...
         <div class="form-group row">
          ...
          <div class="col-6 pl-0">
           <input type="text" name="subject" id="subject" class="form-control bg-white" value="${boardDTO.subject}">
          </div>
         </div>
         <div class="form-group row">
         ...
         <nav class="navbar justify-content-end">
          <button type="submit" class="btn btn-outline-primary mr-sm-1" id="change">
